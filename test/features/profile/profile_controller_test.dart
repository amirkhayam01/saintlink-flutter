...
void main() {
  ...
  test(
    'saves trimmed values, blanks as null, and updates the session',
    () async {
  ...
  test(
    'a validation failure keeps the field errors and leaves the session alone',
    () async {
      auth.updateError = const ApiException(
      ...
      expect(
        container.read(profileControllerProvider).fieldErrors['email'],
        isNotEmpty,
      );
